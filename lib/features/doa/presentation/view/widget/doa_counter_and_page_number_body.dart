        ...
        Center(
          child: Transform.translate(
            ...
            child: GestureDetector(
              onTap: () {
                if(doaaCubit.currentVerseIndex==doa.verses!.length-1 && doaaCubit.currentCountIndex+1 == doa.verses!.last.count){
    
                }else{
                if (doaaCubit.currentVerseIndex !=
                    doa.verses!.length) {
                  doaaCubit.changeCount(
                    count: doa.verses![doaaCubit.currentVerseIndex]
                            .count ??
                        1,
                  );
                  if (doaaCubit.currentCountIndex ==
                      doa.verses![doaaCubit.currentVerseIndex]
                          .count) {
                    doaaCubit.swapToNextVerseForward(
